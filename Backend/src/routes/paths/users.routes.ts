...
UsersRouter.get('/:id', [check('id', 'The id of username is required and must be validated').isLength({ min: 1 }), check('id', 'The id is must required in query').not().isEmpty(), validateFields], getUsersById);
